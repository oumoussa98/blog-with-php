...
if ($loggedin) die(header('Location:  addNewPost.php?view='.$user)) ; 
  ...
  if ($result->num_rows == 0)
      {
        $error = "<span class='error'>Invalid Username or 
          ...
          $_SESSION['passw'] = $passw;
            die("You are now logged in" . header('Location: addNewPost.php?view='.$uname)); 
            }}}
...
<body>
    <form name ="login" method="POST" action="addNewPosts.php"  class="login-form">$error
